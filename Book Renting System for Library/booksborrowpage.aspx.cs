...
{
    public partial class booksborrowpage : System.Web.UI.Page
    {
        ...
        void returnBook()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Delete from borrow_table WHERE book_id='" + TextBox1.Text.Trim() + "' AND student_id='" + TextBox2.Text.Trim() + "'", con);
        ...
        bool checkIfIssueEntryExist()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from borrow_table WHERE student_id='" + TextBox2.Text.Trim() + "' AND book_id='" + TextBox1.Text.Trim() + "'", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
                if (dt.Rows.Count >= 1)
