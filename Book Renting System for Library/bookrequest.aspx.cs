...
namespace Book_Renting_System_for_Library
{
    public partial class bookrequest : System.Web.UI.Page
    {
        ...
        {
            if (checkIfBookExist1() && checkIfStudentExist1())
            {

                if (checkIfIssueEntryExist1())
                {
                    returnBook();
                }
                else
        ...
        void returnBook()
        {
            try
            {
                ...
                if (result > 0)
                {
                    ...
                    Response.Write("<script>alert('List Clear Successfully');</script>");
                    GridView1.DataBind();
        ...
        void issueBook()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO borrow_table(student_id,student_name,book_id,book_name,borrow_date,due_date) values(@student_id,@student_name,@book_id,@book_name,@borrow_date,@due_date)", con);
                ...
                cmd.Parameters.AddWithValue("@borrow_date", TextBox5.Text.Trim());
                ...
                con.Close();
                Response.Write("<script>alert('Book issuesd successfully.');</script>");
        ...
        {
            DateTime dtval = DateTime.Parse(TextBox5.Text);
            //Add values here
            DateTime formatteddays = dtval.AddDays(Int16.Parse(TextBox7.Text));
            TextBox6.Text = formatteddays.ToString("MM/dd/yyyy");
        }
    }
}
