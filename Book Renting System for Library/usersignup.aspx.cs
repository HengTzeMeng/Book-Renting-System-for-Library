    ...
    public partial class usersignup : System.Web.UI.Page
    {
        ...
        void signUpNewStudent()
        {
            ...
            { 
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO student_table(full_name,date_of_birth,contact_no,email,state,city,postcode,full_address,student_id,password,account_status) values(@full_name,@date_of_birth,@contact_no,@email,@state,@city,@postcode,@full_address,@student_id,@password,@account_status)", con);
