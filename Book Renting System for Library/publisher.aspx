<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="publisher.aspx.cs" Inherits="Book_Renting_System_for_Library.publisher" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="400px" src="imgs/pubsss.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
         ...
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:con2 %>" SelectCommand="SELECT * FROM [publisher_table]"></asp:SqlDataSource>
                     <div class="col">
